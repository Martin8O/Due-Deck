...
const cs: Dict = {
  ...
  "rec.yearly": "Ročně",
  "rec.quarterly": "Čtvrtletně",
  "rec.monthly": "Měsíčně",
  "field.start": "Datum pořízení / začátku",
  "field.expiry": "Datum expirace *",
  "field.payment": "Datum platby (opakující se)",
  "field.payment_hint":
    "Den, kdy se platí. Zobrazí se v kalendáři opakovaně podle zvolené frekvence (měsíčně / čtvrtletně / ročně).",
  "field.price": "Cena",
  "field.currency": "Měna",
...
const en: Dict = {
  ...
  "field.payment": "Payment date (recurring)",
  "field.payment_hint":
    "The day payment is due. It will appear repeatedly in the calendar according to the selected frequency (monthly / quarterly / yearly).",
  "field.price": "Price",
